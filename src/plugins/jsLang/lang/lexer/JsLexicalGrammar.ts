...
export class JsLexicalGrammar implements LexicalGrammar {
     ...
     */
    public static readonly KEYWORD = LexicalBuilder.make("KEYWORD", /\b(?:break|case|catch|class|const|continue|debugger|default|delete|do|else|export|extends|finally|for|function|if|import|in|instanceof|let|new|null|return|super|switch|this|throw|true|false|try|typeof|var|void|while|with|yield|async|await|undefined|constructor)\b/);

    /**
     * Token for valid JavaScript identifiers.
     */
    public static readonly IDENTIFIER = LexicalBuilder.make("IDENTIFIER", /^[$_\p{ID_Start}][$_\u200C\u200D\p{ID_Continue}]*/u);

    /**
     * Token for number literals (decimal, hex, binary, octal, scientific).
     */
    public static readonly NUMBER_LITERAL = LexicalBuilder.make("NUMBER_LITERAL", /^(?:0[xX](?:[0-9a-fA-F]_?)+|0[bB](?:[01]_?)+|0[oO](?:[0-7]_?)+|(?:(?:\d(?:_?\d)*)?(?:\.(?:\d(?:_?\d)*)?)?|\.\d(?:_?\d)*)(?:[eE][+-]?\d(?:_?\d)*)?)(?![0-9_.eE])/);
     ...
     * Token for hashtag '#'
     */
    public static readonly HASHTAG = LexicalBuilder.make("HASHTAG", /#/);

    /**
     * List of JS Keywords
     * */
    public static readonly KEYWORD_LIST: Set<string> = new Set(["break", "case", "catch", "class", "const", "continue", "debugger", "default", "delete", "do", "else", "export", "extends", "finally", "for", "function", "if", "import", "in", "instanceof", "let", "new", "null", "return", "super", "switch", "this", "throw", "true", "false", "try", "typeof", "var", "void", "while", "with", "yield", "undefined", "constructor"]);

    /**
     * Regex to match JS numbers
     * */
    public static readonly NUMBER_REGEX = /^(?:0[xX](?:[0-9a-fA-F]_?)+(?![0-9_.eE])|0[bB](?:[01]_?)+(?![0-9_.eE])|0[oO](?:[0-7]_?)+(?![0-9_.eE])|(?:\d(?:_?\d)*\.(?:\d(?:_?\d)*)?|\d(?:_?\d)*|\.\d(?:_?\d)*)(?:[eE][+-]?\d(?:_?\d)*(?![0-9_.])|(?![0-9_.eE])))/;
